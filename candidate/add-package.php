								...
								<div class="panel-body">									
										<div class="col-sm-6">
											...
											<div class="form-group">
												...
												<input type="date" name="package_from" class="form-control">
											</div>
										...
										<div class="col-sm-6">											
											<div class="form-group">
												...
												<label class="radio-inline"><input type="radio" name="package_name" value="Beginner" checked>Beginner</label>
											...
											<div class="form-group">
												...
												<input type="date" name="package_to" class="form-control">
											</div>
										</div>							
								</div>

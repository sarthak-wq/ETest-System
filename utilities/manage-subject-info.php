					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>SManage Subjects Info ubjects</span></li>
							</ol>
					...
					<!-- start: page -->
							...
							<header class="panel-heading">
								<div class="panel-actions">
   								...
   								<div class="row">
								   <h2 class="panel-title" style="display: inline-block;"> Subjects Info </h2>
									<a type="button" style="float: right; margin-right: 80px;" class="btn btn-primary align-right"  href="add-subject-info.php" >Add <i class="fa fa-plus"></i></a>
								</div>
							</header>
										...
										if (is_array($results) || is_object($results))  {
										 ...
										 foreach ($results as $key => $row) { ?>
											<tr class="gradeX">
												...
												<td class="actions">
													<a href="edit-subject-info.php?id=<?php echo $row['id']; ?>" class="btn btn-success btn-sm btn-custom rounded-0" title="Edit" alt="Edit" style="color: white"><i class="fa fa-pencil"></i></a>

<?php
	...
	if(!empty($_GET['id']) && $_GET['delete']=="Delete") {
		...
		$result = $crud->delete($noticeId, 'tbl_category');
	 ...
	 if(!empty($_GET['id']) && $_GET['edit']=="Update") {
		...
		$categoryId = $crud->escape_string($_GET['id']);
...
?>
				...
				<section role="main" class="content-body">
					...
					<form method="post" action="classes/category_code.php">
                      <div class="row">
                      	<div class="form-group">
						<label class="col-sm-3 control-label">Category Name<span class="required">*</span></label>
						<div class="col-sm-6">
							<input type="text" name="category_name" class="form-control" value="<?php echo $cname; ?>" placeholder="..." required/>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-editable">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td class="actions">
												<a href="manage-category.php?id=<?php echo $row['id']; ?>&edit=Update"class="btn btn-success btn-sm btn-custom rounded-0"><i class="fa fa-pencil" title="Edit" alt="Edit" style="color: white"></i></a>
												<a href="manage-category.php?id=<?php echo $row['id']; ?>&delete=Delete" onclick="return confirm('do you want to delete this Record?');"  class="btn btn-danger btn-sm btn-custom rounded-0"  title="View"  style="color: white"><i class="fa fa-trash-o"></i></a>
											</td>
										</tr>
										<?php } ?>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form action="classes/category_code.php" class="mx-auto" method="post">

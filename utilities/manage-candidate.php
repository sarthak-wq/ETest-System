<?php 
   ...
   if(!empty($_GET['id'])) {
      ...
      $result = $crud->delete($noticeId, 'tbl_candidate_registration');
									...
									<tbody>
										<?php $i =1; foreach ($results as $key => $row) { ?>
											<tr class="gradeX">
												...
												<td> <img src="avatar/<?php echo $row['avatar']; ?>" width="50" height = "50"></td>
												...
												<td class="actions">
													<a href="edit-candidate.php?id=<?php echo $row['id']; ?>"  class="btn btn-success btn-sm btn-custom rounded-0"><i class="fa fa-pencil" title="Edit" alt="Edit" style="color: white"></i></a>
													<a href="manage-candidate.php?id=<?php echo $row['id']; ?>" onclick="return confirm('do you want to delete this Record?');" class="btn btn-danger btn-sm rounded-0 btm-custom" title="Delete"  style="color: white"><i class="fa fa-trash-o"></i></a>
												</td>
											</tr>
										<?php } ?>
									</tbody>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form action="classes/candidate_code.php" class="mx-auto" method="post">

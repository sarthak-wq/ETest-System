...
<input type="hidden" id="masg" value="<?php echo $_GET['name']; ?>" >
									...
									<section class="panel panel-featured-left panel-featured-quartenary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Total Departments</h4>
														<div class="info">
															<strong class="amount">3765</strong>
														</div>
													</div>
...
<script type="text/javascript">
   console.log(document.getElementById('masg').value);
   document.getElementById('adminname').innerHTML=document.getElementById('masg').value;
</script>